import { adapterFun, assign, bulkGetShim, clone, guardedConsole, hasLocalStorage, invalidIdError, listenerCount, nextTick, normalizeDdocFunctionName, once, parseDdocFunctionName, pick, upsert } from 'pouchdb-utils';
...
import { BAD_REQUEST, INVALID_ID, INVALID_REV, MISSING_BULK_DOCS, MISSING_DOC, NOT_AN_OBJECT, QUERY_PARSE_ERROR, REV_CONFLICT, UNKNOWN_ERROR, createError, generateErrorFromResponse } from 'pouchdb-errors';
